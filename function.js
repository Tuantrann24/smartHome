...
document.getElementById('btn1').addEventListener('click', function() {
  ...
  document.getElementById('fan').src = 'fan_running.png';
});
...
document.getElementById('btn9').addEventListener('click', function() {
  ...
  document.getElementById('fan').src = 'fan.png';
});
...
document.getElementById('btn2').addEventListener('click', function() {
  ...
  document.getElementById('bulb').src = 'light_on.png';
});
...
document.getElementById('btn10').addEventListener('click', function() {
  ...
  document.getElementById('bulb').src = 'light_bulb.png';
});
  // Lắng nghe sự thay đổi trên cơ sở dữ liệu Firebase
firebase.database().ref('Livingroom').child('Device').on('value', function(snapshot) {
...
function updateCurtainImage(value){
  ...
  {
  img3.src = "curtain.png";
  }
  else
  {
  img3.src = "curtain_half.png";
  } 
}
...
document.getElementById('btn4').addEventListener('click', function() {
  ...
  document.getElementById('hood').src = 'kitchen_hood.png';
});
...
document.getElementById('btn12').addEventListener('click', function() {
  ...
  document.getElementById('hood').src = 'kitchen_off.png';
});
  // Lắng nghe sự thay đổi trên cơ sở dữ liệu Firebase
...
document.getElementById('btn5').addEventListener('click', function() {
  ...
  document.getElementById('humidifier').src = 'humidifier.png';
});
document.getElementById('btn13').addEventListener('click', function() {
  ...
  document.getElementById('humidifier').src = 'Humidifier_off.png';
});
    // Lắng nghe sự thay đổi trên cơ sở dữ liệu Firebase
...
document.getElementById('btn6').addEventListener('click', function() {
  ...
  document.getElementById('fan_bed').src = 'fan_running.png';
});
...
document.getElementById('btn14').addEventListener('click', function() {
  ...
  document.getElementById('fan_bed').src = 'fan.png';
});
firebase.database().ref('Bedroom/Fan').on('value', function(snapshot) {
  ...
  document.getElementById('btn7').addEventListener('click', function() {
    ...
    document.getElementById('airfilter_bed').src = 'air_filter.png';
  });
  ...
  document.getElementById('btn15').addEventListener('click', function() {
    ...
    document.getElementById('airfilter_bed').src = 'air_off.png';
  });
...
function updateCurtainImage(value1){
  if (value1 == 1) {
    ...
    img4.src = "curtain.png";
  } else {
    img4.src = "curtain_half.png";
  } 
}
...
function updateBulbImage(value2){
  if (value2 == 1) {
    img5.src = "light_bulb.png";
  } else if (value2 >= 60) {
    img5.src = "light_on.png";
  } else {
    img5.src = "light_half.png";
  }
}
